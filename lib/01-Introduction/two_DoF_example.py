...
def setUpWorld(initialSimSteps=100):
    ...
    # Load plane
    plane_path = '../data/'
    p.loadURDF(plane_path+"plane.urdf", [0, 0, -1], useFixedBase=True)

    sleep(0.1)
    p.configureDebugVisualizer(p.COV_ENABLE_RENDERING,0)
    # Load Baxter
    baxter_common_path = '../data/'
    baxterId = p.loadURDF(baxter_common_path+"baxter_common/baxter_description/urdf/toms_baxter.urdf", useFixedBase=True)
...
#       targetPosition=[targetPosX,targetPosY]  
